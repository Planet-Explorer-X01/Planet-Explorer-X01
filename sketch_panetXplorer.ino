...
unsigned int delayTime = 60000;

// vars for the stepper
const int stepsPerRevolution = 2048; // Number of steps per revolution for BYJ48 motor
const int stepperPin1 = 1; // Stepper motor control pin 1
const int stepperPin2 = 3; // Stepper motor control pin 2
const int stepperPin3 = 13; // Stepper motor control pin 3
const int stepperPin4 = 12; // Stepper motor control pin 4


int motorStepTime = 4; // time  to roll one /4 step
...
void loop() {
  ...
  for (int i=0; i< 16; i++)
  {
    ...
    stepperRoll(stepsPerRevolution / (4*16));
    



  // Delay to allow the stepper motor to reach the new position
